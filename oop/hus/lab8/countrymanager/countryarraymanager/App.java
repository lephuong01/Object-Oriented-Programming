...
public class App {
    ...
    public static void testFilterNorthAmericaCountry() {
        /* TODO */
        Country[] countries = new NorthAmericaCountry[]{countryManager.filterNorthAmericaCountry()};
        String codesString = CountryArrayManager.codeOfCountriesToString(countries);
        System.out.println(codesString);
    }
    ...
    public static void testFilterOceaniaCountry() {
        /* TODO */
        Country[] countries = new OceaniaCountry[]{countryManager.filterOceaniaCountry()};
        String codesString = CountryArrayManager.codeOfCountriesToString(countries);
        System.out.println(codesString);
    }
    ...
    public static void testFilterSouthAmericaCountry() {
        /* TODO */
        Country[] countries = new SouthAmericaCountry[]{countryManager.filterSouthAmericaCountry()};
        String codesString = CountryArrayManager.codeOfCountriesToString(countries);
        System.out.println(codesString);
    }
