...
public class Lists {
     ...
     */
    public static void intsertLast(ArrayList<Integer> list, int value) {
        if (list == null) {
            return;
        }
        list.add(value);
    ...
    public static ArrayList<Integer> generateSquare() {
        ArrayList<Integer> generateSquare = new ArrayList<>();
        for (int i = 1; i <= 10; i++) {
           // generateSquare.add(generateSquare.get(i) * generateSquare.get(i));
            generateSquare.add(i * i);
        }
